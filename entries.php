...
// Get all entries
$stmt = $db->prepare("SELECT * FROM entries WHERE user_id = ? AND is_deleted = 0 AND is_archived = 0 ORDER BY created_at DESC");
$stmt->execute([getUserId()]);
...
<head>
    ...
    <title>My Entries — Smart Journal</title>
        ...
        <main class="main-content">
            ...
            <div style="display: flex; gap: 1rem; margin-bottom: 1.5rem; flex-wrap: wrap;">
                <div class="search-input-wrapper" style="flex: 1; min-width: 250px;">
                    ...
                    <input type="text" class="form-input" placeholder="Search your thoughts..." id="searchInput">
                </div>
