...
$stmt = $db->prepare("SELECT * FROM entries WHERE user_id = ? AND is_deleted = 0 AND is_archived = 1 ORDER BY created_at DESC");
$stmt->execute([getUserId()]);
...
<head>
    ...
    <title>Archived — Smart Journal</title>
    ...
    <div class="streak-badge">
        🔥 <?= $streak ?> day streak
            ...
            <nav class="sidebar-nav">
                ...
                <a href="archived.php" class="nav-item active">
                    <span class="nav-icon">📦</span>
                    <span>Archived</span>
                </a>
